    ...
    <div className="relative min-h-screen overflow-hidden p-4 md:p-8 flex flex-col">
      ...
      <div className="max-w-6xl mx-auto space-y-10 flex-grow w-full">
        <header className="py-6 border-b border-zinc-800 flex items-center justify-between">
          ...
          {/* SECCIÓN MODIFICADA: Botón de GitHub y Grupo 3 más grande */}
          <div className="hidden sm:flex items-center justify-end gap-4 text-right">
            <a
              href="https://github.com/MBreadd/Simulador-FIFO-FIFO2da" 
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 px-4 py-2 bg-zinc-800 hover:bg-zinc-700 text-zinc-200 text-sm font-medium rounded-md border border-zinc-700 transition-colors"
            >
              <img 
                src="/github-logo.png" 
                alt="GitHub Logo" 
            ...
            <span className="text-xl font-bold font-mono bg-zinc-900 px-4 py-2 rounded-md border border-zinc-800 text-zinc-300">
              Grupo 3
            </span>
          </div>
        </header>
